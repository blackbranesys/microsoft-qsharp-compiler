...
namespace Microsoft.Quantum.QsCompiler
{
    public class CompilationLoader
    {
        ...
        private QsCompilation ReplaceTargetSpecificImplementations(IEnumerable<string> paths, Uri rewriteStepOrigin, int nrReferences)
        {
            ...
            var targetSpecificDecompositions = QsCompilation.New(replacements, ImmutableArray<QsQualifiedName>.Empty, QsNullable<ICallGraph>.Null);
        ...
        private bool SerializeSyntaxTree(MemoryStream ms)
        {
            ...
            var compilation = QsCompilation.New(fromSources.ToImmutableArray(), this.CompilationOutput.EntryPoints, QsNullable<ICallGraph>.Null);
            try
            {
